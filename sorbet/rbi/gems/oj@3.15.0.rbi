...
# source://oj//lib/oj/state.rb#1
module JSON
  class << self
    # source://oj//lib/oj/json.rb#47
    def dump_default_options; end

    # source://oj//lib/oj/json.rb#51
    def dump_default_options=(h); end

    # source://oj//lib/oj/json.rb#70
    def generator; end

    # source://oj//lib/oj/json.rb#66
    def generator=(g); end

    # source://oj//lib/oj/json.rb#62
    def parser; end

    # source://oj//lib/oj/json.rb#58
    def parser=(p); end
  end
end

# source://oj//lib/oj/json.rb#75
class JSON::Ext::Parser
  # @raise [TypeError]
  # @return [Parser] a new instance of Parser
  #
  # source://oj//lib/oj/json.rb#76
  def initialize(src); end

  # @raise [TypeError]
  #
  # source://oj//lib/oj/json.rb#88
  def parse; end

  # @raise [TypeError]
  #
  # source://oj//lib/oj/json.rb#82
  def source; end
end
...
#
# source://oj//lib/oj/json.rb#109
class JSON::GenericObject < ::OpenStruct
  # source://oj//lib/oj/json.rb#169
  def as_json(*_arg0); end

  # source://oj//lib/oj/json.rb#153
  def to_hash; end

  # source://oj//lib/oj/json.rb#173
  def to_json(*a); end

  # source://oj//lib/oj/json.rb#165
  def |(other); end

  class << self
    # source://oj//lib/oj/json.rb#145
    def dump(obj, *args); end

    # source://oj//lib/oj/json.rb#125
    ...
    #
    # source://oj//lib/oj/json.rb#117
    def json_creatable=(_arg0); end

    # @return [Boolean]
    #
    # source://oj//lib/oj/json.rb#113
    def json_creatable?; end

    # source://oj//lib/oj/json.rb#119
    def json_create(data); end

    # source://oj//lib/oj/json.rb#140
    def load(source, proc = T.unsafe(nil), opts = T.unsafe(nil)); end
  end
end

# source://oj//lib/oj/json.rb#103
